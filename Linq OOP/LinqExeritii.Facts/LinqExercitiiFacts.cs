...
namespace LinqExeritii.Facts
{
    public class LinqExercitiiFacts
    {
        ...
        {
            var iPhone12 = new ProductInStock { Name = "iPhone 12", ProductCode = "01", Cost = 1000 };
            var samsungS21 = new ProductInStock { Name = "Samsung S21", ProductCode = "02", Cost = 1000 };
            var samsungNote10 = new ProductInStock { Name = "Samsung Note10", ProductCode = "03", Cost = 700 };
            var nokia3 = new ProductInStock { Name = "Nokia 3", ProductCode = "04", Cost = 500 };
            var iPhone11 = new ProductInStock { Name = "iPhone 11", ProductCode = "05", Cost = 800 };
            var iPhoneX = new ProductInStock { Name = "iPhone X", ProductCode = "06", Cost = 700 };
            var samsungS10 = new ProductInStock { Name = "Samsung S10", ProductCode = "07", Cost = 400 };
            var samsungFold2 = new ProductInStock { Name = "Samsung Fold2", ProductCode = "08", Cost = 1500 };
            var samsungFlip2 = new ProductInStock { Name = "Samsung Flip2", ProductCode = "09", Cost = 1000 };
            var huaweiP20 = new ProductInStock { Name = "Huawei P20", ProductCode = "10", Cost = 800 };
            var iPhoneXR = new ProductInStock { Name = "iPhone XR", ProductCode = "11", Cost = 400 };
            var iPhone8 = new ProductInStock { Name = "iPhone 8", ProductCode = "12", Cost = 400 };

            ProductInStock emptyProduct = new ProductInStock { };
            string emptyMessage = "Product in stock";

            var newStock = new Stock((ProductInStock product, string message) => {
