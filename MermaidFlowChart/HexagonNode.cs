...
namespace MermaidFlowChart
{
    ...
    {
        private readonly int defaultWidth = 90;
        ...
        public string DrawShape()
        {
            ...
            (int x, int y) e = (coordinatesCenter.x - dimensions.width / 2, coordinatesCenter.y);
            (int x, int y) f = (coordinatesCenter.x - dimensions.width / 2 + (defaultTextWidth * 2), coordinatesCenter.y - dimensions.height / 2);
