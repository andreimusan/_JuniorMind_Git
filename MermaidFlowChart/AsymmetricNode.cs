...
{
    public class AsymmetricNode : IFlowChartShape
    {
        ...
        public AsymmetricNode(string textInput)
        {
            text = textInput;
        ...
        public string DrawShape()
        {
            ...
            (int x, int y) b = (coordinatesCenter.x + dimensions.width / 2, coordinatesCenter.y + dimensions.height / 2);
            (int x, int y) c = (coordinatesCenter.x - dimensions.width / 2 - (defaultTextWidth * 3), coordinatesCenter.y + dimensions.height / 2);
            (int x, int y) d = (coordinatesCenter.x - dimensions.width / 2, coordinatesCenter.y);
            (int x, int y) e = (coordinatesCenter.x - dimensions.width / 2 - (defaultTextWidth * 3), coordinatesCenter.y - dimensions.height / 2);
