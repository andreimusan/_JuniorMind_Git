...
namespace MermaidFlowChart
{
    public class RoundEdgedNode
    {
        ...
        public string DrawShape()
        {
            ...
            string shape = "<rect fill=\"#aaaaff\" stroke=\"#3f007f\" stroke-width=\"1\" rx=\"7\" ry=\"7\" height=\"" + dimensions.height + "\" width=\"" + dimensions.width + "\" x=\"0\" y=\"0\"/>";
